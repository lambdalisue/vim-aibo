...
require('aibo').setup({
  ...
  disable_startinsert_on_startup = false, -- Disable auto insert mode on startup (default: false)
  disable_startinsert_on_insert = false,  -- Disable auto insert mode when entering insert mode (default: false)
})
```
